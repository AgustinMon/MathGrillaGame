...
class _GameScreenState extends ConsumerState<GameScreen> {
  ...
  void _showRewardedAd() {
    if (_rewardedAd == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'El anuncio no está listo todavía, intenta en unos segundos',
          ),
        ),
      );
      return;
    ...
    _rewardedAd!.fullScreenContentCallback = FullScreenContentCallback(
      onAdDismissedFullScreenContent: (ad) {
        ...
        ref
            ...
            .toggleTimer(false); // Reanudamos el tiempo
      },
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(gameProvider, (previous, next) {
      ...
      if (next.levelNumber == 1 &&
          next.showTutorial &&
          previous?.levelNumber != 1) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
              ...
              SafeArea(
                ...
                child:
                    Column(
                        ...
                        .animate(target: gameState.errorTrigger.toDouble())
                        .shake(
                          hz: 8,
          ...
          content: Column(
            ...
            children: [
              _buildTutorialStep(
                ...
                'Arrastra números a la grilla',
              ),
              _buildTutorialStep(
                Icons.grid_on,
                'Forma ecuaciones (Ej: 2 + 2 = 4)',
              ),
              _buildTutorialStep(
                Icons.timer,
                '¡Resuelve todo antes del límite!',
              ),
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            shape: BoxShape.circle,
            border: Border.all(
              color: iconColor.withOpacity(isDark ? 0.6 : 0.3),
              width: 1.5,
            ),
          ),
              ...
              Row(
                children: [
                  ...
                  buildCircularButton(
                    ...
                    () => ref
                        .read(gameProvider.notifier)
                        .startNewLevel(state.levelNumber),
                  ),
                ],
              ),
              buildCircularButton(
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    ...
                    Icon(
                      state.isTimerPaused ? Icons.play_arrow : Icons.pause,
                      color: textColor,
                      size: 18,
                    ),
                  ],
  ...
  Widget _buildGrid(
    ...
    final spacing =
        0.0; // Eliminamos el espacio para look de crucigrama clásico
          ...
          child: MathTile(
            ...
            color: isSolved
                ...
                : (isMathOnly
                      ...
                      : (cell.isFixed ? null : Colors.blueAccent)),
  ...
  Widget _buildFooter(GameState state, WidgetRef ref, Translations l10n) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final footerTiles = List<String>.from(state.currentLevel?.footerTiles ?? [])
      ..sort((a, b) => (int.tryParse(a) ?? 0).compareTo(int.tryParse(b) ?? 0));
    final machineTiles = List<String>.from(state.machineTiles)
      ..sort((a, b) => (int.tryParse(a) ?? 0).compareTo(int.tryParse(b) ?? 0));

    if (footerTiles.isEmpty &&
        machineTiles.isEmpty &&
        state.machineInputA == null &&
        state.machineInputB == null)
      return const SizedBox.shrink();
      ...
      child: Container(
        ...
        child: Column(
          children: [
            GestureDetector(
              onTap: () => setState(
                () => _isInventoryCollapsed = !_isInventoryCollapsed,
              ),
    ...
    return Wrap(
      ...
      children: tiles.map((value) {
        return Draggable<Map<String, dynamic>>(
          ...
          feedback: MathTile(
            value: value,
            size: inventorySize + 5,
            color: isMachine ? Colors.pinkAccent : null,
            isInventory: true,
          ),
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                  ...
                  .animate(target: state.machineOp == '+' ? 0 : 1)
              ...
              ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text(
                          l10n.text('fusion_button'),
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                  )
                  .animate(target: canFuse ? 1 : 0)
  ...
  Widget _buildMachineSlot(
    ...
    return DragTarget<Map<String, dynamic>>(
      onAcceptWithDetails: (details) => notifier.addToMachine(
        slot,
        details.data['value'],
        isMachineTile: details.data['isMachine'] ?? false,
      ),
      builder: (context, candidateData, rejectedData) {
        return GestureDetector(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Icon(
              isTimeUp ? Icons.timer_off : Icons.heart_broken,
              color: Colors.redAccent,
              size: 64,
            ),
            const SizedBox(height: 20),
